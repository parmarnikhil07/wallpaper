...
<div class="row-fluid">
	<div class="span12">
		<div class="box">
			...
			<div class="content">
				<?php echo $this->Form->create('Template', array('url' => array('controller' => 'emailTemplates', 'action' => 'edit'), 'type' => 'file', 'class' => 'form-horizontal', 'id' => 'editEmailForm'));
				...
				<div class="form-row row-fluid">
					<?php echo $this->Form->input('Template.content', array('label' => array('text' =>'Contents', 'class' => 'form-label span4'), 'div' => array('class' => 'span8'), 'class' => "span6 controls")); ?>
				</div>
				<div class="form-row row-fluid">
...
if (!empty($validationRules)) {
	echo $this->FormValidation->generateValidationRules('#editEmailForm', $validationRules);
}
?>
