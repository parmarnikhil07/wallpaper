        ...
        <div class="col-lg-12">
            <div class="box">
                <div class="box-header">
                    <h3>
                        <span class="left">Reported wallpapers</span>
                    </h3>
                </div>
                <div class="box-body">
                                ...
                                <tbody>
                                    ...
                                    foreach ($spamsArr as $spamArr) {
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo isset($spamArr['Wallpaper']['title']) ? $spamArr['Wallpaper']['title'] : '-'; ?></td>
                                            <td>
                                                <video width="130" controls>
                                                    <source src="<?php echo WALLPAPER_VIDEO_URL . $spamArr['Wallpaper']['video']; ?>">
                                                </video>
                                            </td>
                                            <td class="txtLeft"><?php echo isset($spamArr['WallpaperUser']['user_name']) ? $spamArr['WallpaperUser']['user_name'] : '-'; ?></td>
                                            <td class="txtLeft"><?php echo isset($spamArr['SpamReport']['reason_title']) ? $spamArr['SpamReport']['reason_title'] : '-'; ?></td>
                                            <td>
                                                <?php echo $this->Html->link($this->Html->tag('span', null, array('class' => 'icon12 icon-ban-circle')), array('action' => 'ignore_wallpaper_report', $spamArr['SpamReport']['id']), array('escape' => false, 'title' => 'Ignore report'), __('Are you sure you want to ingnore?')); ?>
                                                <?php echo $this->Form->postLink($this->Html->tag('span', null, array('class' => 'con12 icon-trash')), array('action' => 'delete_wallpaper_report', $spamArr['SpamReport']['id']), array('escape' => false, 'title' => 'Delete report'), __('Are you sure you want to delete?')); ?>
                                            </td>
                                        </tr>
                                        <?php
                                        $indx++;
