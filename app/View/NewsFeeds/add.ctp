        ...
        <div class="col-lg-12">
            <div class="box">
                <div class="box-header with-border">
                    <h4>
                        <span>Add news/feature </span>
                    </h4>
                </div>
                <div class="box-body">
                    <?php
                    echo $this->Form->create('NewsFeed', array('url' => array('controller' => 'news_feeds', 'action' => 'add'), 'type' => 'file', 'class' => 'form-horizontal', 'inputDefaults' => array(
                    ...
                    <div class="form-group">
                        <?php echo $this->Form->input('NewsFeed.message', array('placeholder'=>"Enter Message", 'type' => 'textarea', 'maxlength' => '500', 'label' => array('text' => 'Message *', 'class' => 'col-lg-2 control-label'), 'div' => false, 'class' => 'form-control  text')); ?>
                    </div>                    
                </div>
...
if (!empty($validationRules)) {
    echo $this->FormValidation->generateValidationRules('#addNewsFeedForm', $validationRules);
}
?>
</script>